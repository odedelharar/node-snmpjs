...
ParseContext()
{
	...
	obj.parse = function parse (raw, src){
		parser.yy = this;
		...
		obj.content._setOrigin(raw, src);
		return (obj.content);
	};
	
	obj.parseError = function parseError(str, hash)
	{
		throw new MessageParseError(str, hash);
	};
	
	ParseContext.prototype.setContent = function setContent(aContent)
	{
		obj.content = aContent;
	};
